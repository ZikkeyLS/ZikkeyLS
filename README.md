...
- Currently working in [SkyrimRP](https://discord.gg/CXM2SMscCq)
- Good at **Networking (TCP, UDP, RUDP, Frameworks), system architecture, MMO development**
- Main skills - C++, Redis, Postgres, Docker, Networking (RUDP), client-server development, microservice
